        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co wss://stream.binance.com https://api.binance.com https://*.tradingview.com https://auth.privy.io https://*.privy.io https://api.hyperliquid.xyz https://js.stripe.com https://*.posthog.com https://*.sentry.io",
